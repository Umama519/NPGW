...
export class PortInSummaryReportComponent {
  ...
  selectedExport:  string = 'S';
    ...
    Fetch() {
      ...
      const url = `${environment.apiBaseUrl}/api/PortinSummaryReport?fromdate=${txt_FromDate}&todate=${txt_ToDate}&userid=${this.loginUser}`;
    ...
    export(res:any, file:any) {
      ...
      this.excelService.exportToFile( 
        this.GridData, 'Port In Summary Report', {
          nprdate: 'NPR Date',
          recepient: 'Recepient',
          donor: 'Donor',
          portin: 'Port In',
