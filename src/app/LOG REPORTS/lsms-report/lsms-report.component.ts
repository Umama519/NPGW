...
export class LsmsReportComponent {
    ...
    Fetch() {
      ...
      const url = `${environment.apiBaseUrl}/api/LSMSReport?fromdate=${txt_FromDate}&todate=${txt_ToDate}&userid=${this.loginUser}`;
