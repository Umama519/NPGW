...
export class NpcSendingReportComponent {
constructor(private http: HttpClient, private el: ElementRef, private renderer: Renderer2, private datepickerService: DatepickerService, private excelService: ExcelExportService) { }
    ...
    Fetch() {
      ...
      const url = `${environment.apiBaseUrl}/api/NPCSendingReport?fromdate=${txt_FromDate}&todate=${txt_ToDate}&userid=${this.loginUser}`;
    ...
    export(res:any, file:any) {
      ...
      this.excelService.exportToFile( 
        this.GridData, 'NPC Sending Report', {
        mobile: 'Mobile #',
        descrip: 'Description',
